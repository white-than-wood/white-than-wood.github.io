...
#### hexo deploy 发布配置
  ...
  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">部署至 Github Page 个人网站.</p>
...
<p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">部署至个人申请购买的云服务器.</p>
...
> 步骤
   ...
   * 无论是部署至 GitHub Page 个人网站,还是部署至个人申请购买的云服务器,上面三点是必须要实行的,proxy 403 问题主要是在部署至个人申请购买的云服务器中时会遇到.

   Github 的 OAuth 认证.

   <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">前提是得有一个 github 账号,才能注册 OAuth application ,这是<a href='https://github.com/settings/applications/new'> OAuth 应用注册地址</a>.</p>
...
server {
   ...
   * 使用 Gitalk 官方搭建的代理.
     ...
     据gitalk issue<a href='https://github.com/gitalk/gitalk/issues/433'> gitalk 授权登录后报错403</a>,直接将使用 Gitalk 官方搭建的代理就可解决 403 forbidden 的问题,之前 Gitalk 官方搭建的代理由于太多人接入导致被官方限制使用,用户经常发现不能正常使用,现在已经对代理进行优化改进,不会出现限制使用的情况.
   ...
   * 更新 gitalk 版本至1.7.2.
     ...
     据gitalk issue<a href='https://github.com/gitalk/gitalk/issues/433'> gitalk 授权登录后报错403</a>,直接将 gitalk 版本升级至1.7.2就可解决 403 forbidden 的问题.
...
#### hexo GitHub Page个人网站自定义域名
  ...
  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">阿里云域名解析.</p>
...
> 步骤
  ...
  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">A记录是将域名指向一个IPV4地址.<br/>CNAME是将域名指向另外一个域名.</p>
  ...
  ![](https://image.white-than-wood.zone/hexo/website_host_analy_ping.png)

  主机记录,解析后的域名基本上就两种,'@'和'www'.

  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">'@' 是源域名(主域名 white-than-wood.zone).<br/>'www' 则是 www.white-than-wood.zone.</p>

  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">GitHub Page个人网站CNAME配置.</p>
  ...
  ![](https://image.white-than-wood.zone/hexo/website_host_github_cname.png)

  我这两种方式全部使用.全部搞定之后,就可以通过 white-than-wood.zone 访问 white-than-wood.github.io GitHub Page 个人网站. 

> 延伸

  <p style="background-color: #f3f3f3;padding: 10px;font-size: 0.875em;font-family: 'PingFang SC', 'Microsoft YaHei';">既然已经通过阿里云服务 A记录 或者 CNAME 解析域名,为什么还需要在 GitHub Page 个人网站上配置 CNAME ?</p>
